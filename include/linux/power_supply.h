...
enum {
	POWER_SUPPLY_MOISTURE_NONE = 0,
	POWER_SUPPLY_MOISTURE_DETECTED,
...
enum power_supply_typec_mode {
	...
	POWER_SUPPLY_TYPEC_SOURCE_DEBUG_ACCESSORY_DEFAULT,		/* Rp default / Rp default */
	POWER_SUPPLY_TYPEC_SOURCE_DEBUG_ACCESSORY_DEFAULT_MEDIUM,	/* Rp default / Rp 1.5A */
	POWER_SUPPLY_TYPEC_SOURCE_DEBUG_ACCESSORY_DEFAULT_HIGH,		/* Rp default / Rp 3A */
	POWER_SUPPLY_TYPEC_SOURCE_DEBUG_ACCESSORY_MEDIUM,		/* Rp 1.5A / Rp 1.5A */
	POWER_SUPPLY_TYPEC_SOURCE_DEBUG_ACCESSORY_MEDIUM_HIGH,		/* Rp 1.5A / Rp 3A */
