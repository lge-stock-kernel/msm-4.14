...
//static unsigned int modem_ssr_count; //not used
...
//static DEVICE_ATTR(trigger, S_IRUGO, lge_qsdl_trigger_show, NULL); //not used
static DEVICE_ATTR(apps_info, S_IRUGO, lge_qsdl_apps_info_show, NULL);
//static DEVICE_ATTR(modem_info, S_IRUGO, lge_qsdl_modem_info_show, NULL); //not used
...
static struct attribute *lge_qsdl_attrs[] = {
	&dev_attr_apps_info.attr,
	//&dev_attr_modem_info.attr, //not used
	NULL
};
