...
static void tps61280_probe_async(void *data, async_cookie_t cookie);
static int tps61280_probe(struct i2c_client *client,const struct i2c_device_id *id){
	async_schedule(tps61280_probe_async, (void *)client);
	return 0;
}
...
//	printk("tps61280_init  OK %d\n",lge_get_sku_carrier());
	if(HW_SKU_NA_GSM == lge_get_sku_carrier() || HW_SKU_NA == lge_get_sku_carrier()){
		bringup = 1;
	}
#endif
#endif
