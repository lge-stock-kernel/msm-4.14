...
#ifdef CONFIG_LGE_PM
#define USBIN_PATH_BIT 			BIT(2)
#define BATTERY_PATH_BIT 		BIT(1)
#endif
#define VALID_INPUT_POWER_SOURCE_STS_BIT	BIT(0)

#define DCDC_CMD_OTG_REG			(DCDC_BASE + 0x40)
#ifdef CONFIG_LGE_USB
#define FAST_ROLE_SWAP_CMD_BIT			BIT(1)
#endif
...
#define SNK_DEBUG_ACCESS_RPHIGH_RPHIGH_BIT	BIT(5)
#define SNK_DEBUG_ACCESS_RPMID_RPHIGH_BIT	BIT(4)
#define SNK_DEBUG_ACCESS_RPMID_RPMID_BIT	BIT(3)
#define SNK_DEBUG_ACCESS_RPSTD_RPHIGH_BIT	BIT(2)
#define SNK_DEBUG_ACCESS_RPSTD_RPMID_BIT	BIT(1)
#define SNK_DEBUG_ACCESS_RPSTD_RPSTD_BIT	BIT(0)
#endif
...
#ifdef CONFIG_LGE_USB
#define TYPEC_VBUS_STATUS_BIT			BIT(5)
#endif
