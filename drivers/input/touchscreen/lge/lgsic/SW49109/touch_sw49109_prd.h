...
#define PT_FRAME_1_OFFSET		(0x102E)	//(0x1240)
#define PT_FRAME_2_OFFSET		(0x1172)	//(0x1384)
#define PT_FRAME_3_OFFSET		(0x12B6)	//(0x14C8)
#define PT_FRAME_4_OFFSET		(0x13FA)	//(0x160C)
