...
static const unsigned char InitCodeVal[CNT_INITCODE]    = { 0x01, 0x9A, 0x00, 0x4E, 0x33, 0x0B, 0x0B, 0x64, 0x64, 0x96, 0x6A, 0x5F, 0xA7, 0x01, 0x9A, 0x00, 0x3E, 0xD0, 0xA4, 0x14, 0x09, 0x0F, 0x07, 0x33, 0x04, 0x2F }; // requested by HW RF ANT sooho.bang@lge.com 2019-02-13 mail
#elif defined (CONFIG_MACH_SM6150_MH3) || defined (CONFIG_MACH_SM6150_MH3_LAO_COM)
static const unsigned char InitCodeAddr[CNT_INITCODE]   = { 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x09, 0x0A, 0x0B, 0X0C, 0X0D, 0x0E, 0x11, 0x12, 0x13, 0x14, 0x15, 0x16, 0x17, 0x18, 0x19, 0x1A, 0x1B, 0x1C, 0x1D};
//static const unsigned char InitCodeVal[CNT_INITCODE]    = { 0x01, 0x9A, 0x00, 0x4E, 0x33, 0x0B, 0x0B, 0x64, 0x64, 0x96, 0x6A, 0x5F, 0xA7, 0x01, 0x9A, 0x00, 0x3E, 0xD0, 0xA4, 0x14, 0x09, 0x0F, 0x07, 0x33, 0x04, 0x2F };
//static const unsigned char InitCodeVal[CNT_INITCODE]    = { 0x01, 0x9A, 0x00, 0x4E, 0x33, 0x0B, 0x0B, 0x64, 0x64, 0x96, 0x6A, 0x57, 0XA7, 0x01, 0x9A, 0x00, 0x19, 0xD0, 0xA4, 0x14, 0x19, 0x0F, 0x07, 0x33, 0x01, 0x2F }; // requested by HW RF ANT taiwoong.han@lge.com 2019-05-07 mail
//static const unsigned char InitCodeVal[CNT_INITCODE]    = { 0x01, 0x9A, 0x00, 0x21, 0x33, 0x0B, 0x0B, 0x64, 0x64, 0x96, 0x6A, 0x57, 0x27, 0x01, 0x9A, 0x00, 0x10, 0xD0, 0xA4, 0x14, 0x19, 0x0F, 0x07, 0x33, 0x03, 0x2F }; // requested by HW RF ANT taiwoong.han@lge.com 2019-05-30 http://mlm.lge.com/di/browse/MHTHREE-891
//static const unsigned char InitCodeVal[CNT_INITCODE]    = { 0x01, 0x9A, 0x00, 0x21, 0x33, 0x0B, 0x0B, 0x64, 0x64, 0x96, 0x6A, 0x57, 0x07, 0x01, 0x9A, 0x00, 0x11, 0xD0, 0xA4, 0x14, 0x19, 0x0F, 0x07, 0x33, 0x04, 0x12 }; // requested by HW RF ANT haseok.jo@lge.com 2019-08-06 mail
static const unsigned char InitCodeVal[CNT_INITCODE]      = { 0x01, 0x9A, 0x00, 0x21, 0x33, 0x0B, 0x0B, 0x64, 0x64, 0x82, 0x64, 0x57, 0x07, 0x01, 0x9A, 0x00, 0x11, 0xD0, 0xA4, 0x14, 0x19, 0x0F, 0x07, 0x33, 0x04, 0x12 }; // requested by HW RF ANT haseok.jo@lge.com 2019-08-14 mail
#else
static const unsigned char InitCodeAddr[CNT_INITCODE]   = { 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x09, 0x0A, 0x0B, 0X0C, 0X0D, 0x0E, 0x11, 0x12, 0x13, 0x14, 0x15, 0x16, 0x17, 0x18, 0x19, 0x1A, 0x1B, 0x1C, 0x1D};
...
#endif /*CONFIG_MACH_SDM450_CV7AS*/
#endif
